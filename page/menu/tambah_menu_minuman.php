...
function create($data)
{
    ...
    // var_dump($image_name);
    // die;
    mysqli_query($koneksi, "INSERT INTO tb_minuman VALUES(
        '',
        '$nama_menu',
        '$harga',
        '$gambar_menu'
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center">Tambah Menu</h4>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_menu" placeholder="Masukkan nama menu" class="form-control" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="card-footer">
                            <div class="col">
                            <button type="submit" name="simpan" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"> </i>Tambah</button>
